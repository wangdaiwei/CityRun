...
bkcore.hexgl.CarControls = function(domElement)
{
	var self = this;
...
bkcore.hexgl.CarControls.prototype.control = function(threeMesh)
{
	this.mesh = threeMesh;
...
bkcore.hexgl.CarControls.prototype.reset = function(position, rotation)
{
...
bkcore.hexgl.CarControls.prototype.destroy = function()
{
	this.active = false;
	this.destroyed = true;
...
bkcore.hexgl.CarControls.prototype.update = function(dt)
{
...
bkcore.hexgl.CarControls.prototype.boosterCheck = function(dt)
{
...
bkcore.hexgl.CarControls.prototype.collisionCheck = function(dt)
{
...
bkcore.hexgl.CarControls.prototype.heightCheck = function(dt)
{
...
bkcore.hexgl.CarControls.prototype.getRealSpeed = function(scale)
{
	return Math.round(
...
bkcore.hexgl.CarControls.prototype.getRealSpeedRatio = function()
{
	return Math.min(
		this.maxSpeed, 
		this.speed+this.boost
...
bkcore.hexgl.CarControls.prototype.getSpeedRatio = function()
{
	return (this.speed+this.boost)/ this.maxSpeed;
};

bkcore.hexgl.CarControls.prototype.getBoostRatio = function()
{
	return this.boost / this.boosterSpeed;
};

bkcore.hexgl.CarControls.prototype.getShieldRatio = function()
{
	return this.shield / this.maxShield;
};

bkcore.hexgl.CarControls.prototype.getShield = function(scale)
{
	return Math.round(
		this.shield
		* (scale == undefined ? 1 : scale)
