...
RacingGame.prototype.loadRacer = function()
{
	...
	// init loading
	loader.load('../models/Audi_Car/Audi.js', function ( geometry, materials ) {
		that.onRacerLoaded( geometry, materials );
  	});
	// var model = new JSONModel;
...
RacingGame.prototype.onRacerLoaded = function( geometry, materials )
{
	...
	this.player.init({ mesh : this.mesh, camera : camera, exhaust:true,
		sounds : this.sounds});
