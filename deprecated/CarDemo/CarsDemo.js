...
MyDemoApplication.prototype.initPhysics = function(){
  ...
  loader.load( "./models/Audi_Car/Audi_Body.js", function( bodyGeometry, bodyMaterials ) {
    loader.load( "./models/Audi_Car/Audi_Wheel.js", function( wheelGeometry, wheelMaterials ) {
      var s=1;

      bodyGeometry.computeBoundingBox();
      var bodybb = bodyGeometry.boundingBox;

      var mesh = new THREE.Mesh(bodyGeometry, bodyMaterials );
      ...
      for(var i=0; i<wmesh.length; i++){
        var wheelmesh = new THREE.Mesh(wheelGeometry, wheelMaterials);
